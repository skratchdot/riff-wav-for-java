...
/**
 * This is the item provider adapter for a {@link com.skratchdot.riff.wav.ChunkDataListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChunkDataListTypeItemProvider
	 ...
	 * @generated
	 */
	public ChunkDataListTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		ChunkID labelValue = ((ChunkDataListType)object).getChunkID();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ChunkDataListType_type") :
			getString("_UI_ChunkDataListType_type") + " " + label;
	}
