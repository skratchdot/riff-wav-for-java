...
/**
 * This is the item provider adapter for a {@link com.skratchdot.riff.wav.Segment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SegmentItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLengthInSamplesPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Segment_cuePointID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Segment_cuePointID_feature", "_UI_Segment_type"),
				 WavPackage.Literals.SEGMENT__CUE_POINT_ID,
				 false,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Length In Samples feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLengthInSamplesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Segment_lengthInSamples_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Segment_lengthInSamples_feature", "_UI_Segment_type"),
				 WavPackage.Literals.SEGMENT__LENGTH_IN_SAMPLES,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Long labelValue = ((Segment)object).getCuePointID();
