...
public class ChunkUnknownItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChunkUnknown_data_feature"),
	...
	/**
	 * This adds a property descriptor for the Wav Random Access File Pointer feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addWavRandomAccessFilePointerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	public String getText(Object object) {
		...
		return getString("_UI_ChunkUnknown_type") + " " + chunkUnknown.getBlockAlignedSize();
	}
