...
public abstract class ChunkDataListTypeTest extends ChunkTest {
	...
	/**
	 * Constructs a new Chunk Data List Type test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ChunkDataListTypeTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Chunk Data List Type test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
